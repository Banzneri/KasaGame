...
// Since this script is used for visual debugging, we exclude most of it in builds.
        ...
        void DrawCharactersBounds()
        {
            ...
            for (int i = 0; i < textInfo.characterCount; i++)
            {
                ...
                UnityEngine.Gizmos.DrawLine(baselineStart, baselineEnd);
                ...
                UnityEngine.Gizmos.color = Color.cyan;
                UnityEngine.Gizmos.DrawLine(ascenderStart, ascenderEnd);
                UnityEngine.Gizmos.DrawLine(descenderStart, descenderEnd);
                ...
                UnityEngine.Gizmos.color = Color.cyan;
                UnityEngine.Gizmos.DrawLine(capHeightStart, capHeightEnd);
                ...
                UnityEngine.Gizmos.DrawLine(topAdvance, bottomAdvance);
        ...
        void DrawLineBounds()
        {
            ...
            for (int i = 0; i < textInfo.lineCount; i++)
            {
                ...
                UnityEngine.Gizmos.DrawLine(m_Transform.TransformPoint(lineInfo.lineExtents.min), m_Transform.TransformPoint(lineInfo.lineExtents.max));
        ...
        void DrawRectangle(Vector3 BL, Vector3 TR, Color color)
        {
            ...
            UnityEngine.Gizmos.DrawLine(new Vector3(BL.x, BL.y, 0), new Vector3(BL.x, TR.y, 0));
            UnityEngine.Gizmos.DrawLine(new Vector3(BL.x, TR.y, 0), new Vector3(TR.x, TR.y, 0));
            UnityEngine.Gizmos.DrawLine(new Vector3(TR.x, TR.y, 0), new Vector3(TR.x, BL.y, 0));
            UnityEngine.Gizmos.DrawLine(new Vector3(TR.x, BL.y, 0), new Vector3(BL.x, BL.y, 0));
        }
        ...
        void DrawRectangle(Vector3 bl, Vector3 tl, Vector3 tr, Vector3 br, Color color)
        {
            ...
            UnityEngine.Gizmos.DrawLine(bl, tl);
            UnityEngine.Gizmos.DrawLine(tl, tr);
            UnityEngine.Gizmos.DrawLine(tr, br);
            UnityEngine.Gizmos.DrawLine(br, bl);
        }
