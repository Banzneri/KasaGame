...
public class Scene : MonoBehaviour {
	...
	public void LoadScene()
	{
		...
		{
			checkpoints[i].transform.position = TranslateMyVector3ToVector3(data.checkPoints[i].pos);
			checkpoints[i].transform.rotation = TranslateMyQuaternionToQuaternion(data.checkPoints[i].rot);
